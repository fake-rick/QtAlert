...
{
    m_message->raise();
    m_message->setStyleSheet("background-color:#30cc30;color:#ffffff;font-size:20px;font-style:'Microsoft YaHei';border:0px");
...
{
    m_message->raise();
    m_message->setStyleSheet("background-color:#cc3030;color:#ffffff;font-size:20px;font-style:'Microsoft YaHei';border:0px");
    m_message->setText(text);
    m_messageAntG->start();
}
